...
@section('body')
    <div class="page-header">
        <div class="page-header__container container">
            @if(session()->has('news_search_tag_id') || session()->has('news_search_category_id') || session()->has('news_search_query'))
                ...
                @if( session()->has('news_search_category_id') )
                    <span class="badge bg-warning p-2 m-2" style="font-size: 1em">
                        <a href="{{ route('news.search.clear', 'news_search_category_id') }}">
                ...
                @if( session()->has('news_search_tag_id') )
                    <span class="badge bg-warning p-2 m-2" style="font-size: 1em">
                        <a href="{{ route('news.search.clear', 'news_search_tag_id') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000"
                                 class="bi bi-x-lg" viewBox="0 0 16 16">
                              <path
                                  d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
                ...
                @if( session()->has('news_search_query') )
                    <span class="badge bg-warning p-2 m-2" style="font-size: 1em">
                        <a href="{{ route('news.search.clear', 'news_search_query') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000"
                                 class="bi bi-x-lg" viewBox="0 0 16 16">
                              <path
                                  d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
