                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline text-center"
                                ...
                                @foreach($order->products as $product)
                                    <tr>
                                        ...
                                        <td class="dtr-control sorting_1 d-flex flex-row align-items-baseline" tabindex="0">
                                            <a href="">
                                            ...
                                            <form action="{{ route('order.actions.change_product_quantity', [$order, $product]) }}" class="d-flex flex-row" method="post">
                                                @csrf
                                                <input type="number" min="1" class="form-control" name="quantity" value="{{ $product->pivot->quantity }}">
                                ...
                                @foreach($order->product_sets as $product_set)
                                    <tr>
                                        ...
                                        <td class="dtr-control sorting_1 d-flex flex-row align-items-baseline" tabindex="0">
                                            ...
                                            <form action="{{ route('order.actions.change_product_set_quantity', [$order, $product_set]) }}" class="d-flex flex-row" method="post">
                                                @csrf
                                                <input type="number" min="1" class="form-control" name="quantity" value="{{ $product_set->pivot->quantity }}">
                                                <button class="btn btn-sm btn-outline-success p-0 ml-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                                        <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
                                                    </svg>
