            ...
            <div class="card card-dark col p-0 m-auto">
                <div class="card-header">
                    ...
                    <div class="form-check d-inline ml-4">
                        <input class="form-check-input" type="checkbox" id="badge_applied" name="badge_applied" {{ $product->badge ? 'checked' : '' }}>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="badge_text"
                                   id="badge_text" placeholder="Enter a badge text" value="{{ $product->badge ? $product->badge->text : '' }}">
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-10">
                            @foreach($badge_styles as $style)
                                <div class="form-check-inline">
                                    <input class="form-check-input" type="radio" name="badge_style_id" id="badge_radio_{{ $style->id }}" value="{{ $style->id }}" {{ ($product->badge) && ($style->id == $product->badge->badge_style_id) ? 'checked' : '' }}>
