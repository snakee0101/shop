                    ...
                    <div class="block-sidebar__item">
                        <div class="widget-filters widget" data-collapse
                            ...
                            <div class="widget-filters__list">
                                <x-search_filters.alphabetic title="Select item" />
                                <x-search_filters.range title="Select range" />
                                <x-search_filters.checkbox title="Select more items" />
                                <x-search_filters.color title="Select colors" />
                            </div>
