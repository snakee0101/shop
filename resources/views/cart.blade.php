        ...
        <div class="mobilemenu__content">
            <ul class="mobile-links mobile-links--level--0" data-collapse
                ...
                <li class="mobile-links__item" data-collapse-item>
                    <div class="mobile-links__item-title"><a href="{{ route('index-2') }}" class="mobile-links__item-link">Home</a>
                            ...
                            <div class="nav-panel__nav-links nav-links">
                                <ul class="nav-links__list">
                                    <li class="nav-links__item nav-links__item--with-submenu"><a
                                            href="{{ route('index-2') }}"><span>Home <svg class="nav-links__arrow" width="9px"
                                                                              height="6px"><use
            ...
            <div class="container">
                <table class="cart__table cart-table">
                    ...
                    <tr class="cart-table__row">
                        ...
                        <td class="cart-table__column cart-table__column--product"><a href="#"
                                                                                      class="cart-table__product-name">Undefined
                            Tool IRadix DPS3000SY 2700 watts</a></td>
                    ...
                    <tr class="cart-table__row">
                        ...
                        <td class="cart-table__column cart-table__column--product"><a href="#"
                                                                                      class="cart-table__product-name">Brandix
                ...
                <div class="cart__actions">
                    ...
                    <div class="cart__buttons"><a href="{{ route('index-2') }}" class="btn btn-light">Continue Shopping</a> <a
                    ...
                    <div class="col-12 col-md-7 col-lg-6 col-xl-5">
                        <div class="card">
                            <div class="card-body"><h3 class="card-title">Cart Totals</h3>
                                ...
                                <a class="btn btn-primary btn-xl btn-block cart__checkout-button" href="checkout.html">Proceed
                                    to checkout</a></div>
                        </div>
                    </div>
                </div>
