<template>
    <div class="card mb-5">
        <div class="modal fade" :id="'move_wishlist_modal_' + wishlist_object.id" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control form-select" id="wishlist_name"
                                    v-model="wishlist_id_to_move_to">
        ...
        <div class="card-header d-flex align-content-center"
             :class="wishlist.is_active ? 'bg-dark text-white font-weight-bold' : ''">
            ...
            <div class="d-flex align-content-center mb-3 px-4 pb-0 pt-0">
                <div class="d-inline-block flex-grow-1" v-if="user_object.id">
                    ...
                    <button class="btn btn-warning" data-toggle="modal"
                            :data-target="'#move_wishlist_modal_' + wishlist_object.id">Move
                    </button>
    ...
    methods: {
        ...
        move_to_wishlist() {
            if (this.wishlist_id_to_move_to === 0)
                return alert('No wishlist is selected');
        ...
        save_selection(wishlist_id, product_id, selected) {
            ...
            if (selected)
                return this.selected_product_ids.push(product_id);
        ...
        selectAll() {
            ...
            this.selected_product_ids = this.all_selected ? this.wishlist_object.products.map(product => product.id) : [];
        ...
        confirm_rename() {
            if (this.new_name === '')
                return alert('new wishlist name is required');
